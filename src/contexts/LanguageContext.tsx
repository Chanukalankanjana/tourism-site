...
type TranslationKeys =
  ...
  | "destinations.destination.bentota.fullDescription"
  ...
  | "destinations.destination.bentota.name"
  | "destinations.destination.bentota.location"
  | "destinations.destination.bentota.description"
  | "destinations.destination.bentota.highlights.whales"
  | "destinations.destination.bentota.highlights.beaches"
  | "destinations.destination.bentota.highlights.surfing"
  | "destinations.destination.bentota.highlights.coconut"
  | "destinations.destination.bentota.bestTime"
  | "destinations.destination.bentota.difficulty"
  | "destinations.destination.bentota.groupSize"
  ...
  | "packages.tours.kandySigiriya.name"
  | "packages.tours.kandySigiriya.subtitle"
  | "packages.tours.kandyElla.name"
  | "packages.tours.kandyElla.subtitle"
  | "packages.tours.gemSriLanka.name"
  | "packages.tours.gemSriLanka.subtitle"
  | "packages.tours.goldenTour.name"
  | "packages.tours.goldenTour.subtitle"
  | "packages.tours.mountSriLanka.name"
  | "packages.tours.mountSriLanka.subtitle"
  | "packages.tours.natureTour.name"
  | "packages.tours.natureTour.subtitle"
  | "packages.tours.kandyDay.name"
  | "packages.tours.kandyDay.subtitle"
  | "packages.tours.dutchFort.name"
  | "packages.tours.dutchFort.subtitle"
  | "packages.tours.mountElla.name"
  | "packages.tours.mountElla.subtitle"
  | "packages.tours.sigiriyaCave.name"
  | "packages.tours.sigiriyaCave.subtitle"
  | "packages.tours.safariTour.name"
  | "packages.tours.safariTour.subtitle"
  // Tour details - Itinerary, Highlights, Included, Excluded
  | "packages.tours.kandySigiriya.itinerary.step01.title"
  | "packages.tours.kandySigiriya.itinerary.step01.description"
  | "packages.tours.kandySigiriya.itinerary.step02.title"
  | "packages.tours.kandySigiriya.itinerary.step02.description"
  | "packages.tours.kandySigiriya.itinerary.step03.title"
  | "packages.tours.kandySigiriya.itinerary.step03.description"
  ...
  // Custom Tours Page
  | "customTours.hero.badge"
  | "customTours.hero.title"
  | "customTours.hero.subtitle"
  | "customTours.form.fullName"
  | "customTours.form.email"
  | "customTours.form.phoneNumber"
  | "customTours.form.preferredStartDate"
  | "customTours.form.numberOfTravelers"
  | "customTours.form.duration"
  | "customTours.form.tourInterests"
  | "customTours.form.budgetPerPerson"
  | "customTours.form.pickupLocation"
  | "customTours.form.specialRequirements"
  | "customTours.form.additionalMessage"
  | "customTours.form.placeholders.fullName"
  | "customTours.form.placeholders.email"
  | "customTours.form.placeholders.phone"
  | "customTours.form.placeholders.numberOfTravelers"
  | "customTours.form.placeholders.duration"
  | "customTours.form.placeholders.tourInterests"
  | "customTours.form.placeholders.budget"
  | "customTours.form.placeholders.pickupLocation"
  | "customTours.form.placeholders.specialRequirements"
  | "customTours.form.placeholders.additionalMessage"
  | "customTours.form.submit"
  | "customTours.form.submitting"
  | "customTours.form.success"
  | "customTours.form.error"
  | "customTours.form.required"
  | "customTours.form.optional"
  // Contact Page Additional
  | "contact.form.title"
...
const translations: { [lang: string]: TranslationMap } = {
  en: {
    ...
    "packages.home.culturalHeritage.name": "4-Day Gem Sri Lanka",
    "packages.home.culturalHeritage.duration": "4 Days",
    "packages.home.culturalHeritage.price": "$499",
    "packages.home.culturalHeritage.originalPrice": "$599",
    "packages.home.adventureWildlife.name": "6-Day Sri Lanka Highlights",
    "packages.home.adventureWildlife.duration": "6 Days",
    "packages.home.adventureWildlife.price": "$799",
    "packages.home.adventureWildlife.originalPrice": "$929",
    "packages.home.beachRelaxation.name": "5-Day Diamond Tour",
    "packages.home.beachRelaxation.duration": "5 Days",
    "packages.home.beachRelaxation.price": "$699",
    "packages.home.beachRelaxation.originalPrice": "$820",
    ...
    "testimonials.sarah.review": "Absolutely incredible experience! The team at Ceylon Vacations made our Sri Lankan adventure unforgettable. From the ancient temples to the stunning landscapes, every moment was perfectly planned.",
    ...
    "destinations.destination.bentota.name": "Bentota Beach",
    "destinations.destination.bentota.location": "Southern Province",
    "destinations.destination.bentota.description": "One of Sri Lanka's most famous beach destinations, perfect for water sports, river safaris, and relaxing seaside resorts.",
    "destinations.destination.bentota.highlights.whales": "Water Sports & Jet Ski",
    "destinations.destination.bentota.highlights.beaches": "Wide Golden Beach",
    "destinations.destination.bentota.highlights.surfing": "Madu River Boat Safari",
    "destinations.destination.bentota.highlights.coconut": "Turtle Hatchery & Scenic Coastline",
    "destinations.destination.bentota.bestTime": "November to April",
    "destinations.destination.bentota.difficulty": "Easy",
    "destinations.destination.bentota.groupSize": "2-15 people",
    "destinations.destination.bentota.fullDescription": "Bentota is a coastal town on the southern coast of Sri Lanka, famous for its long sandy beach, calm waters, and wide range of water sports. Located along the Galle Road and the Colombo–Galle–Hambantota railway line, it is easily accessible from Colombo and is a popular stop on most southern coastal tours.\n\nThe Bentota Beach area offers a relaxing resort atmosphere with many hotels and villas located directly on the shoreline. The calm lagoon and river make it ideal for jet skiing, banana boat rides, water skiing, and other water-based activities. Nearby, the Madu River provides scenic boat safaris through mangroves and small islands.\n\nBentota is also known for its turtle hatcheries, where visitors can learn about sea turtle conservation and see baby turtles before they are released into the ocean. The sunset views along the beach are spectacular, making it a favorite spot for couples and families alike.\n\nWith its combination of adventure, nature, and relaxation, Bentota Beach is a perfect destination for travelers looking to enjoy both activities and quiet seaside time.",
    ...
    // About
    "about.title": "Why Choose Ceylon Vacations?",
    "about.subtitle":
    ...
    "footer.email": "info.ceylonvacations@gmail.com",
    ...
    "about.story.founded":
      "Founded in 2010 by passionate locals who wanted to share the true beauty of Sri Lanka with the world, Ceylon Vacations began as a small family business with a big dream.",
    "about.story.grown":
    ...
    "about.hero.title": "About Ceylon Vacations",
    "about.hero.subtitle":
    ...
    "destinations.detail.included.whaleWatchingTour": "Guided water sports session",
    ...
    "packages.hero.title": "Premium Tour Packages",
    "packages.hero.subtitle":
    ...
    "packages.planCustomTour": "Plan My Tour",
    ...
    "packages.tours.kandySigiriya.name": "Kandy & Sigiriya Tour",
    "packages.tours.kandySigiriya.subtitle": "2 DAY KANDY AND SIGIRIYA - Discover the highlights of Sigiriya (UNESCO) and Kandy. Visit Pinnawala, Kandy Tooth Relic Temple, explore Peradeniya Botanical Gardens, and more.",
    "packages.tours.kandySigiriya.itinerary.step01.title": "Early Morning - Hotel Pick-Up & Drive to Kandy",
    "packages.tours.kandySigiriya.itinerary.step01.description": "Begin your journey early to make the most of your day. Travel through lush countryside towards Kandy.",
    "packages.tours.kandySigiriya.itinerary.step02.title": "Cultural Highlights & Nature in Kandy",
    "packages.tours.kandySigiriya.itinerary.step02.description": "Meet and feed friendly elephants at Pinnawala Elephant Orphanage, visit Ceylon tea Giragama tea factory, learn about Sri Lanka's natural ayurvedic garden (cinnamon, cardamom, herbal remedies), visit Temple of the Tooth in Kandy, and explore botanical garden in Peradeniya. Relax and spend the night in Kandy hotel.",
    "packages.tours.kandySigiriya.itinerary.step03.title": "Sigiriya & Dambulla Heritage",
    "packages.tours.kandySigiriya.itinerary.step03.description": "Ascend the world-famous Sigiriya Lion Rock (UNESCO) - explore the frescoes of the Sigiriya maidens, the Mirror Wall, and the ancient summit palace ruins. Explore the largest and best-preserved Dambulla Cave Temple (UNESCO) - admire over 150 Buddha statues and centuries-old murals covering the cave walls.",
    "packages.tours.kandySigiriya.highlights.0": "Visit Pinnawala Elephant Orphanage",
    "packages.tours.kandySigiriya.highlights.1": "Explore Ceylon tea factory",
    "packages.tours.kandySigiriya.highlights.2": "Learn about ayurvedic remedies",
    "packages.tours.kandySigiriya.highlights.3": "Visit Temple of the Tooth in Kandy",
    "packages.tours.kandySigiriya.highlights.4": "Explore Royal Botanical Gardens",
    "packages.tours.kandySigiriya.highlights.5": "Climb the iconic Sigiriya Rock Fortress (UNESCO)",
    "packages.tours.kandySigiriya.highlights.6": "Discover ancient cave temples at Dambulla (UNESCO)",
    "packages.tours.kandySigiriya.included.0": "Private air-conditioned vehicle and guide",
    "packages.tours.kandySigiriya.included.1": "Bottled water",
    "packages.tours.kandySigiriya.included.2": "Hotel dinner and breakfast",
    "packages.tours.kandySigiriya.included.3": "On Trip Transport",
    "packages.tours.kandySigiriya.excluded.0": "Entry Fees",
    "packages.tours.kandySigiriya.excluded.1": "Box Lunch, Dinner & Snacks",
    "packages.tours.kandyElla.name": "Kandy & Ella Tour",
    "packages.tours.kandyElla.subtitle": "1 DAY KANDY AND ELLA TOUR - Explore Kandy & Nuwara Eliya's charm - tea plantations, cultural gems, and breathtaking hill country scenery on our expertly guided journey.",
    "packages.tours.gemSriLanka.name": "Gem Sri Lanka",
    "packages.tours.gemSriLanka.subtitle": "4 days 3 night tour - Embark on a captivating Sri Lanka Cultural tour through ancient cities and heritage. Explore UNESCO World Heritage Sites of Sigiriya Rock Fortress and Dambulla Cave Temple.",
    "packages.tours.goldenTour.name": "Golden Tour",
    "packages.tours.goldenTour.subtitle": "7 days 6 night - The perfect combination of comfort, culture, and scenic beauty. Explore coastal Negombo, cultural Kandy, misty highlands of Nuwara Eliya, tea plantations, wildlife safari, and stunning southern coastline.",
    "packages.tours.mountSriLanka.name": "Mount of Sri Lanka",
    "packages.tours.mountSriLanka.subtitle": "3 days 2 nights - This hill country tour package is the perfect escape for travellers seeking the charm of Sri Lanka's up-country. With cool, breezy weather, it offers both relaxation and adventure. Features wildlife encounters with safari in Udawalawe National Park.",
    "packages.tours.natureTour.name": "Nature Tour",
    "packages.tours.natureTour.subtitle": "6 days 5 night tour - Sri Lanka Cultural Triangle tour through ancient cities and heritage. Explore UNESCO World Heritage Sites of Sigiriya Rock Fortress, Dambulla Cave Temple, Ella city, Nine Arch Bridge, Yala National Park, and Galle Fort (UNESCO).",
    "packages.tours.kandyDay.name": "Kandy Tour",
    "packages.tours.kandyDay.subtitle": "01 DAY : Nature in Kandy - Early Morning Hotel Pick-Up & Drive to Kandy. Visit Pinnawala Elephant Orphanage, Ceylon tea factory, ayurvedic garden, Temple of the Tooth, and Royal Botanic Gardens Peradeniya.",
    "packages.tours.dutchFort.name": "Dutch Colina Fort Tour",
    "packages.tours.dutchFort.subtitle": "01 DAY : dutch colina fort tour - Explore Galle Fort (UNESCO), Madu River boat safari, turtle farm, and moonstone mining shops",
    "packages.tours.mountElla.name": "Mount Hill Ella",
    "packages.tours.mountElla.subtitle": "01 DAY : mount hill ella - Explore Nine-arched bridge, Ravana waterfall, Little Adam's Peak, train ride, and ayurveda garden",
    "packages.tours.sigiriyaCave.name": "Sigiriya & Cave Temple",
    "packages.tours.sigiriyaCave.subtitle": "01 DAY tour (UNESCO) - Early Morning Hotel Pick-Up & Drive to Sigiriya. Climb Sigiriya Rock Fortress (UNESCO) and explore Dambulla Cave Temple (UNESCO).",
    "packages.tours.safariTour.name": "Safari Tour",
    "packages.tours.safariTour.subtitle": "01 DAY : Yala National Park OR UDWALA PARK - Our Wildlife Safari & Tour in Sri Lanka combines thrilling wildlife encounters with the serene beauty of exciting safari.",
    ...
    "packages.tours.colombo.highlights.shoppingMall": "Shopping Mall",
    "packages.tours.colombo.highlights.lotusTower": "Lotus Tower (without tickets)",
    ...
    "packages.tours.colombo.included.vehicle": "Comfortable vehicle",
    ...
    // Custom Tours Page
    "customTours.hero.badge": "Customize Your Perfect Journey",
    "customTours.hero.title": "Customize Your Tour",
    "customTours.hero.subtitle": "Create a personalized travel experience tailored to your preferences, interests, and budget",
    "customTours.form.fullName": "Full Name",
    "customTours.form.email": "Email",
    "customTours.form.phoneNumber": "Phone Number",
    "customTours.form.preferredStartDate": "Preferred Start Date",
    "customTours.form.numberOfTravelers": "Number of Travelers",
    "customTours.form.duration": "Duration (days)",
    "customTours.form.tourInterests": "Tour Interests / Preferences",
    "customTours.form.budgetPerPerson": "Budget per person (optional)",
    "customTours.form.pickupLocation": "Pickup Location",
    "customTours.form.specialRequirements": "Special Requirements / Requests",
    "customTours.form.additionalMessage": "Additional Message",
    "customTours.form.placeholders.fullName": "Enter your full name",
    "customTours.form.placeholders.email": "your.email@example.com",
    "customTours.form.placeholders.phone": "+94 XX XXX XXXX",
    "customTours.form.placeholders.numberOfTravelers": "1",
    "customTours.form.placeholders.duration": "e.g., 7",
    "customTours.form.placeholders.tourInterests": "e.g., Cultural sites, beaches, wildlife, adventure activities, etc.",
    "customTours.form.placeholders.budget": "USD",
    "customTours.form.placeholders.pickupLocation": "e.g., Airport, Hotel name, City",
    "customTours.form.placeholders.specialRequirements": "e.g., Dietary restrictions, accessibility needs, special occasions, etc.",
    "customTours.form.placeholders.additionalMessage": "Any additional information you'd like to share...",
    "customTours.form.submit": "Submit",
    "customTours.form.submitting": "Submitting...",
    "customTours.form.success": "Thank you! Your custom tour request has been submitted successfully. We'll get back to you soon!",
    "customTours.form.error": "Something went wrong. Please try again or contact us directly.",
    "customTours.form.required": "required",
    "customTours.form.optional": "optional",
    ...
    // WhatsApp and Phone
    "whatsapp.phoneNumber.en": "+94705233117",
    "whatsapp.phoneNumber.ru": "+94762312699",
  ...
  ru: {
    ...
    "nav.packages": "Пакеты",
    "nav.tours": "Туры",
    "nav.oneDayTour": "Однодневные туры",
    "nav.customTours": "Индивидуальные туры",
    "nav.services": "Услуги",
    "nav.about": "О нас",
    ...
    "packages.home.culturalHeritage.name": "4 дня — Драгоценная Шри‑Ланка",
    "packages.home.culturalHeritage.duration": "4 дня",
    "packages.home.culturalHeritage.price": "$499",
    "packages.home.culturalHeritage.originalPrice": "$599",
    "packages.home.adventureWildlife.name": "6 дней — Основные достопримечательности",
    "packages.home.adventureWildlife.duration": "6 дней",
    "packages.home.adventureWildlife.price": "$799",
    "packages.home.adventureWildlife.originalPrice": "$929",
    "packages.home.beachRelaxation.name": "5 дней — Алмазный тур",
    ...
    "testimonials.sarah.review": "Невероятный опыт! Команда Ceylon Vacations сделала наше приключение на Шри-Ланке незабываемым. От древних храмов до потрясающих пейзажей - каждый момент был идеально спланирован.",
    ...
    // About
    "about.title": "Почему стоит выбрать Ceylon Vacations?",
    "about.subtitle":
    ...
    "about.story.founded":
      "Основана в 2010 году страстными местными жителями, которые хотели поделиться истинной красотой Шри-Ланки с миром, Ceylon Vacations началась как небольшой семейный бизнес с большой мечтой.",
    "about.story.grown":
    ...
    "about.hero.title": "О Ceylon Vacations",
    "about.hero.subtitle":
    ...
    "destinations.destination.mirissa.name": "Пляж Бентота",
    "destinations.destination.mirissa.location": "Южная провинция",
    "destinations.destination.mirissa.description": "Один из самых известных пляжных курортов Шри-Ланки, идеальный для водных видов спорта, речных сафари и отдыха в прибрежных отелях.",
    "destinations.destination.mirissa.highlights.whales": "Водные виды спорта и гидроциклы",
    "destinations.destination.mirissa.highlights.beaches": "Широкий золотой пляж",
    "destinations.destination.mirissa.highlights.surfing": "Сафари по реке Маду",
    "destinations.destination.mirissa.highlights.coconut": "Питомники морских черепах и живописное побережье",
    ...
    "destinations.destination.mirissa.fullDescription": "Бентота - прибрежный город на южном побережье Шри-Ланки, известный своим длинным песчаным пляжем, спокойными водами и широким выбором водных видов спорта. Расположенный вдоль Галле-роуд и железнодорожной линии Коломбо–Галле–Хамбантота, он легко доступен из Коломбо и является популярной остановкой на большинстве южных прибрежных туров.\n\nПляж Бентота предлагает расслабленную курортную атмосферу с множеством отелей и вилл, расположенных прямо на береговой линии. Спокойная лагуна и река делают его идеальным местом для катания на гидроциклах, банановых лодках, водных лыжах и других водных развлечений. Поблизости река Маду предлагает живописные речные сафари среди мангров и маленьких островков.\n\nБентота также известна своими питомниками морских черепах, где посетители могут узнать о сохранении морских черепах и увидеть детенышей перед их выпуском в океан. Закаты на пляже впечатляют, что делает это место любимым среди пар и семей.\n\nБлагодаря сочетанию приключений, природы и релаксации, пляж Бентота — идеальное направление для путешественников, которые хотят насладиться и активным отдыхом, и спокойным временем у моря.",
    ...
    "destinations.detail.included.whaleWatchingTour": "Организованная водная активность",
    ...
    "packages.hero.title": "Премиум туристические пакеты",
    "packages.hero.subtitle":
    ...
    "packages.planCustomTour": "Спланировать мой тур",
    ...
    "packages.tours.kandySigiriya.name": "Тур Канди и Сигирия",
    "packages.tours.kandySigiriya.subtitle": "2 ДНЯ КАНДИ И СИГИРИЯ - Откройте для себя достопримечательности Сигирии (ЮНЕСКО) и Канди. Посетите Пиннавала, Храм Зуба Будды в Канди, исследуйте Королевские ботанические сады Перадения и многое другое.",
    "packages.tours.kandySigiriya.itinerary.step01.title": "Раннее утро - Трансфер из отеля и поездка в Канди",
    "packages.tours.kandySigiriya.itinerary.step01.description": "Начните свое путешествие рано, чтобы максимально использовать свой день. Путешествуйте по пышной сельской местности в сторону Канди.",
    "packages.tours.kandySigiriya.itinerary.step02.title": "Культурные достопримечательности и природа в Канди",
    "packages.tours.kandySigiriya.itinerary.step02.description": "Встретьтесь и покормите дружелюбных слонов в Слоновьем приюте Пиннавала, посетите чайную фабрику Цейлон Джирагама, узнайте о природном аюрведическом саде Шри-Ланки (корица, кардамон, травяные средства), посетите Храм Зуба Будды в Канди и исследуйте ботанический сад в Перадении. Расслабьтесь и проведите ночь в отеле Канди.",
    "packages.tours.kandySigiriya.itinerary.step03.title": "Наследие Сигирии и Дамбуллы",
    "packages.tours.kandySigiriya.itinerary.step03.description": "Поднимитесь на всемирно известную Скалу Льва Сигирия (ЮНЕСКО) - исследуйте фрески девушек Сигирии, Зеркальную стену и руины древнего дворца на вершине. Исследуйте самый большой и лучше всего сохранившийся Пещерный храм Дамбулла (ЮНЕСКО) - полюбуйтесь более чем 150 статуями Будды и многовековыми фресками, покрывающими стены пещер.",
    "packages.tours.kandySigiriya.highlights.0": "Посетите Слоновий приют Пиннавала",
    "packages.tours.kandySigiriya.highlights.1": "Исследуйте чайную фабрику Цейлон",
    "packages.tours.kandySigiriya.highlights.2": "Узнайте об аюрведических средствах",
    "packages.tours.kandySigiriya.highlights.3": "Посетите Храм Зуба Будды в Канди",
    "packages.tours.kandySigiriya.highlights.4": "Исследуйте Королевские ботанические сады",
    "packages.tours.kandySigiriya.highlights.5": "Поднимитесь на знаменитую Скальную крепость Сигирия (ЮНЕСКО)",
    "packages.tours.kandySigiriya.highlights.6": "Откройте для себя древние пещерные храмы в Дамбулле (ЮНЕСКО)",
    "packages.tours.kandySigiriya.included.0": "Частный автомобиль с кондиционером и гид",
    "packages.tours.kandySigiriya.included.1": "Бутилированная вода",
    "packages.tours.kandySigiriya.included.2": "Ужин и завтрак в отеле",
    "packages.tours.kandySigiriya.included.3": "Транспорт во время поездки",
    "packages.tours.kandySigiriya.excluded.0": "Входные билеты",
    "packages.tours.kandySigiriya.excluded.1": "Обед в коробке, ужин и закуски",
    "packages.tours.kandyElla.name": "Тур Канди и Элла",
    "packages.tours.kandyElla.subtitle": "1 ДЕНЬ КАНДИ И ЭЛЛА - Исследуйте очарование Канди и Нувара-Элии - чайные плантации, культурные жемчужины и захватывающие дух пейзажи горной страны в нашем профессионально организованном путешествии.",
    "packages.tours.gemSriLanka.name": "Драгоценный камень Шри-Ланки",
    "packages.tours.gemSriLanka.subtitle": "4 дня 3 ночи - Отправьтесь в захватывающее культурное путешествие по Шри-Ланке через древние города и наследие. Исследуйте объекты Всемирного наследия ЮНЕСКО: Скальную крепость Сигирия и Пещерный храм Дамбулла.",
    "packages.tours.goldenTour.name": "Золотой тур",
    "packages.tours.goldenTour.subtitle": "7 дней 6 ночей - Идеальное сочетание комфорта, культуры и живописной красоты. Исследуйте прибрежный Негомбо, культурный Канди, туманные нагорья Нувара-Элии, чайные плантации, сафари по дикой природе и потрясающее южное побережье.",
    "packages.tours.mountSriLanka.name": "Гора Шри-Ланки",
    "packages.tours.mountSriLanka.subtitle": "3 дня 2 ночи - Этот тур по горной стране - идеальный побег для путешественников, ищущих очарование высокогорья Шри-Ланки. С прохладной, ветреной погодой он предлагает как расслабление, так и приключения. Включает встречи с дикой природой и сафари в национальном парке Удавалаве.",
    "packages.tours.natureTour.name": "Тур по природе",
    "packages.tours.natureTour.subtitle": "6 дней 5 ночей - Культурный треугольник Шри-Ланки через древние города и наследие. Исследуйте объекты Всемирного наследия ЮНЕСКО: Скальную крепость Сигирия, Пещерный храм Дамбулла, город Элла, Девятиарочный мост, Национальный парк Яла и Форт Галле (ЮНЕСКО).",
    "packages.tours.kandyDay.name": "Тур по Канди",
    "packages.tours.kandyDay.subtitle": "01 ДЕНЬ: Природа в Канди - Ранний утренний трансфер из отеля и поездка в Канди. Посетите Слоновий приют Пиннавала, чайную фабрику Цейлон, аюрведический сад, Храм Зуба Будды и Королевские ботанические сады Перадения.",
    "packages.tours.dutchFort.name": "Тур по голландскому форту Коллина",
    "packages.tours.dutchFort.subtitle": "01 ДЕНЬ: тур по голландскому форту коллина - Исследуйте Форт Галле (ЮНЕСКО), лодочное сафари по реке Маду, черепашью ферму и магазины добычи лунного камня",
    "packages.tours.mountElla.name": "Гора Хилл Элла",
    "packages.tours.mountElla.subtitle": "01 ДЕНЬ: гора хилл элла - Исследуйте Девятиарочный мост, водопад Равана, Малый пик Адама, поездку на поезде и аюрведический сад",
    "packages.tours.sigiriyaCave.name": "Сигирия и пещерный храм",
    "packages.tours.sigiriyaCave.subtitle": "01 ДЕНЬ тур (ЮНЕСКО) - Ранний утренний трансфер из отеля и поездка в Сигирию. Поднимитесь на Скальную крепость Сигирия (ЮНЕСКО) и исследуйте Пещерный храм Дамбулла (ЮНЕСКО).",
    "packages.tours.safariTour.name": "Сафари тур",
    "packages.tours.safariTour.subtitle": "01 ДЕНЬ: Национальный парк Яла ИЛИ УДВАЛА - Наше сафари и тур по дикой природе в Шри-Ланке сочетает захватывающие встречи с дикой природой с безмятежной красотой захватывающего сафари.",
    ...
    "packages.tours.colombo.highlights.shoppingMall": "Торговый центр",
    "packages.tours.colombo.highlights.lotusTower": "Башня Лотоса (без билетов)",
    ...
    "packages.tours.colombo.included.vehicle": "Комфортабельный транспорт",
    ...
    // Custom Tours Page
    "customTours.hero.badge": "Создайте свое идеальное путешествие",
    "customTours.hero.title": "Индивидуальный тур",
    "customTours.hero.subtitle": "Создайте персонализированный туристический опыт, адаптированный к вашим предпочтениям, интересам и бюджету",
    "customTours.form.fullName": "Полное имя",
    "customTours.form.email": "Email",
    "customTours.form.phoneNumber": "Номер телефона",
    "customTours.form.preferredStartDate": "Предпочтительная дата начала",
    "customTours.form.numberOfTravelers": "Количество путешественников",
    "customTours.form.duration": "Продолжительность (дней)",
    "customTours.form.tourInterests": "Интересы / Предпочтения по туру",
    "customTours.form.budgetPerPerson": "Бюджет на человека (необязательно)",
    "customTours.form.pickupLocation": "Место встречи",
    "customTours.form.specialRequirements": "Особые требования / Запросы",
    "customTours.form.additionalMessage": "Дополнительное сообщение",
    "customTours.form.placeholders.fullName": "Введите ваше полное имя",
    "customTours.form.placeholders.email": "ваш.email@example.com",
    "customTours.form.placeholders.phone": "+94 XX XXX XXXX",
    "customTours.form.placeholders.numberOfTravelers": "1",
    "customTours.form.placeholders.duration": "например, 7",
    "customTours.form.placeholders.tourInterests": "например, Культурные объекты, пляжи, дикая природа, приключенческие мероприятия и т.д.",
    "customTours.form.placeholders.budget": "USD",
    "customTours.form.placeholders.pickupLocation": "например, Аэропорт, Название отеля, Город",
    "customTours.form.placeholders.specialRequirements": "например, Диетические ограничения, потребности в доступности, особые случаи и т.д.",
    "customTours.form.placeholders.additionalMessage": "Любая дополнительная информация, которой вы хотели бы поделиться...",
    "customTours.form.submit": "Отправить",
    "customTours.form.submitting": "Отправка...",
    "customTours.form.success": "Спасибо! Ваш запрос на индивидуальный тур успешно отправлен. Мы свяжемся с вами в ближайшее время!",
    "customTours.form.error": "Что-то пошло не так. Пожалуйста, попробуйте снова или свяжитесь с нами напрямую.",
    "customTours.form.required": "обязательно",
    "customTours.form.optional": "необязательно",
