...
const ContactPageContent = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: ["info.ceylonvacations@gmail.com"],
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200 resize-none text-gray-900 placeholder-gray-400"
